<?php
/**
 * FoxyProx Proxmox Provisioning Module
 *
 ...
 * @return string "success" or an error message
 */
function foxyprox_SuspendAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function foxyprox_UnsuspendAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function foxyprox_TerminateAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function foxyprox_ChangePassword(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function foxyprox_ChangePackage(array $params)
{
    try {
        // Call the service's change password function, using the values
        // provided by WHMCS in `$params`.
 ...
 * @return array
 */
function foxyprox_TestConnection(array $params)
{
    try {
 ...
 *
 * @see foxyprox_buttonOneFunction()
 *
 * @return array
 */
function foxyprox_AdminCustomButtonArray()
{
    return array(
 ...
 * @return array
 */
function foxyprox_ClientAreaCustomButtonArray()
{
    return array(
 ...
 *
 * @see http://docs.whmcs.com/Provisioning_Module_SDK_Parameters
 * @see foxyprox_AdminCustomButtonArray()
 *
 * @return string "success" or an error message
 */
function foxyprox_buttonOneFunction(array $params)
{
    try {
 ...
 *
 * @see http://docs.whmcs.com/Provisioning_Module_SDK_Parameters
 * @see foxyprox_ClientAreaCustomButtonArray()
 *
 * @return string "success" or an error message
 */
function foxyprox_actionOneFunction(array $params)
{
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
 ...
 *
 * @see http://docs.whmcs.com/Provisioning_Module_SDK_Parameters
 * @see foxyprox_AdminServicesTabFieldsSave()
 *
 * @return array
 */
function foxyprox_AdminServicesTabFields(array $params)
{
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
        ...
        return array(
            ...
            'Something Editable' => '<input type="hidden" name="foxyprox_original_uniquefieldname" '
                . 'value="' . htmlspecialchars($response['textvalue']) . '" />'
                . '<input type="text" name="foxyprox_uniquefieldname"'
                . 'value="' . htmlspecialchars($response['textvalue']) . '" />',
        );
    } catch (Exception $e) {
        // Record the error in WHMCS's module log.
 ...
 *
 * @see http://docs.whmcs.com/Provisioning_Module_SDK_Parameters
 * @see foxyprox_AdminServicesTabFields()
 */
function foxyprox_AdminServicesTabFieldsSave(array $params)
{
    // Fetch form submission variables.
    $originalFieldValue = isset($_REQUEST['foxyprox_original_uniquefieldname'])
        ? $_REQUEST['foxyprox_original_uniquefieldname']
        : '';

    $newFieldValue = isset($_REQUEST['foxyprox_uniquefieldname'])
        ? $_REQUEST['foxyprox_uniquefieldname']
        : '';
 ...
 * @return array
 */
function foxyprox_ServiceSingleSignOn(array $params)
{
    try {
 ...
 * @return array
 */
function foxyprox_AdminSingleSignOn(array $params)
{
    try {
 ...
 * @return array
 */
function foxyprox_ClientArea(array $params)
{
